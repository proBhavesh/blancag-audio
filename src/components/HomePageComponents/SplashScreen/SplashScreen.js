    ...
    <>
      ...
      {width > 768 ? (
        ...
        <svg
          ...
          viewBox='0 0 0.5555 1'
        >
          <defs>
            <clipPath id='wave' clipPathUnits='objectBoundingBox'>
              <path
                d='M480.9522,280.0288a.0678.0678,0,0,1-.1033,0,.0474.0474,0,0,0-.0748,0,.0676.0676,0,0,1-.1033,0,.0474.0474,0,0,0-.0747,0,.0676.0676,0,0,1-.1033,0,.049.049,0,0,0-.0374-.0182.01.01,0,0,1-.01-.01v1H481v-1a.01.01,0,0,1-.01.01A.0488.0488,0,0,0,480.9522,280.0288Z'
                transform='translate(-480.4449 -280)'
              />
            </clipPath>
          </defs>
        </svg>
